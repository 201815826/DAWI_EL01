...
<h1>Registra Celular</h1>
	...
	<form action="registraCelular" id="id_form"> 
			...
			<div class="form-group">
				...
				<input class="form-control" type="text" id="id_modelo" name="celular.modelo" placeholder="Ingrese el nombre">
			</div>
			<div class="form-group">
				<label class="control-label" for="id_color">Color</label>
				<input class="form-control" type="text" id="id_color" name="celular.color" placeholder="Ingrese el precio">
			</div>
        ...
        fields: {
        	modelo: {
        		...
        		validators: {
                    ...
                    stringLength :{
                    	message:'El modelo es de 5 a 100 caracteres',
                    	min : 5,
                    	max : 100
                    }
                }
